...
//    let mentorType: String
    let mentorCity: String
    let mentorCompany: String
    let mentorDescription: String
    
    init(mentorId: String, mentorName: String, mentorAge: Int,
         mentorCity: String, mentorCompany: String, mentorDescription: String) {
        self.mentorId = mentorId
        self.mentorName = mentorName
        self.mentorAge = mentorAge
//        self.mentorType = mentorType
        self.mentorCity = mentorCity
